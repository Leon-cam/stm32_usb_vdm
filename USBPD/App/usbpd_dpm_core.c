...
{
  dbg_print("PD OS: Initializing tasks...\r\n");
  OS_INIT();
  {
    ...
    if (CADThread == NULL) dbg_print("PD OS: Failed to create CAD task\r\n");
  }
...
DEF_TASK_FUNCTION(USBPD_PE_Task)
{
  ...
  dbg_printf("PD: PE Task started (port %d)\r\n", _port);
