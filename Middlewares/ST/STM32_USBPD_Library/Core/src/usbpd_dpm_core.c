...
#if defined(_VDM)
#define OS_PE_STACK_SIZE                  (520 * DPM_STACK_SIZE_ADDON_FOR_CMSIS)
#elif defined(__AUTHENTICATION__)
#define OS_PE_STACK_SIZE                  (400 * DPM_STACK_SIZE_ADDON_FOR_CMSIS)
#else
...
#define OS_CAD_STACK_SIZE                 (400 * DPM_STACK_SIZE_ADDON_FOR_CMSIS)
